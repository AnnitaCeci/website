...
<section id="sq-home-slider-section">
	...
	<div class="sq-banner-shadow"><img src="<?php echo get_template_directory_uri() // WPCS: XSS OK. ?>/images/banner-shadow.png"></div>
</section>
			...
			if($square_featured_page_id){
				...
				?>
					<div class= "row flex-md-row-reverse  align-items-center">
               		<div class="col-xs-12 col-md-6  align-items-self-center">
